...
class FireBaseFunctions {
  static CollectionReference<Results> getFavoritesCollection() {
    return FirebaseFirestore.instance.collection('Fav').withConverter<Results>(
        // BRAIN_EXCEPTION: this IS the sanctioned Firebase wrapper
